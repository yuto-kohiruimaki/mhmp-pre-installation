...
const REQUIRED_PHOTOS: PhotoUpload[] = [
  {
    ...
    description: "床から天井が映る感じで撮影してください。広さ次第ですが、店舗の端から端まで映るようにお願いします。",
  ...
  {
    id: "outside-right",
    title: "工事場所の写真撮影（店舗外より、店舗の外右から見た写真）",
    description: "店舗の外から撮影。サイドの壁が映るようにお願いします。床から天井までを写してください。",
    exampleImage: "/inspection-port-right.png",
    file: null,
    preview: null,
  },
  {
    id: "outside-left",
    title: "工事場所の写真撮影（店舗外より、店舗の外左から見た写真）",
    description: "店舗の外から撮影。サイドの壁が映るようにお願いします。床から天井までを写してください。",
    exampleImage: "/inspection-port-left.png",
    file: null,
    preview: null,
  },
  {
  ...
  {
    id: "left-side",
    title: "工事場所の写真撮影（店舗の入り口から真横左からの写真）",
    description: "館の通路幅全体が映り込むように、店舗の端っこから撮影",
    exampleImage: "/inspection-port-left-side.png",
    file: null,
    preview: null,
  },
  {
    id: "right-side",
    title: "工事場所の写真撮影（店舗の入り口から真横右からの写真）",
    description: "館の通路幅全体が映り込むように、店舗の端っこから撮影",
    exampleImage: "/inspection-port-right-side.png",
    file: null,
    preview: null,
  },
  {
